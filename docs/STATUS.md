...
This is the detailed, ticket-by-ticket build log - useful for continuing
development, less useful as a first read. See [README.md](../README.md) for
what this project is and how to use it, and [PLAN.md](PLAN.md) for the full
roadmap and each ticket's "AS-BUILT" notes (the authoritative design record).
